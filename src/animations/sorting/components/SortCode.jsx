...
import { BubbleSortCode, BubbleSortInfo, HeapSortCode, HeapSortInfo, InsertionSortCode, InsertionSortInfo, QuickSortCode, QuickSortInfo, SelectionSortCode, SelectionSortInfo, ShellSortCode, ShellSortInfo } from '../algorithms';
...
export const SortCode = () => {
  ...
  const Code = (algorithm) => {
    switch (algorithm) {
      ...
      case 'Selection Sort': return <SelectionSortCode codeRef={codeRef} />
      case 'Heap Sort': return <HeapSortCode codeRef={codeRef} />
  ...
  const Info = (algorithm) => {
    switch (algorithm) {
      case 'Bubble Sort': return <BubbleSortInfo />
      case 'Quick Sort': return <QuickSortInfo />
      case 'Shell Sort': return <ShellSortInfo />
      case 'Insertion Sort': return <InsertionSortInfo />
      case 'Selection Sort': return <SelectionSortInfo />
      case 'Heap Sort': return <HeapSortInfo />
      default: null;
    }
  }
