...
import { PopCode, PushCode, SumergirCode } from '../algorithms';
...
export const StackCode = () => {
  ...
  const Code = (funAction) => {
    switch (funAction) {
      ...
      case 'sumergir': return <SumergirCode codeRef={codeRef} />
      default: null;
    }
  }
            ...
            <ul className="list-disc list-inside text-sm">
              ...
              <li className="mb-2">
                ...
                <ul className="text-sm">
                  ...
                  <li className="mb-1">Sumergir: Mueve el elemento del tope de la pila al final</li>
                </ul>
              </li>
              <li className="mb-2">
