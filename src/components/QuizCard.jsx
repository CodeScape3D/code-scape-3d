...
const QuizCard = ({ logo, titulo, ruta }) => {
  return (
    <>
    <a href="#" >
      <div className="bg-quaternary rounded-lg flex flex-col justify-center items-center xl:mx-auto l lg:w-72  h-60 sm:w-30 sm:h-60 md:w-50 md:h-72 xl:w-96 custom-inner-div containerQuiz transition duration-300 ease-in-out hover:bg-secondary">
